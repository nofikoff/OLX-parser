...
//                console.log(str.substring(2,7));
				...
				//URL профиля автора объявления
                Prof_url = text.Prof_URL = $('.offer-user__actions > h4 > a').attr('href');
...
//getAds('https://www.olx.ua/obyavlenie/sdam-komnatu-posutochno-IDxqwO4.html').then((xxx) => {
//var url_oll = "https://www.olx.ua/obyavlenie/kvartira-posutochno-odnokomnatnaya-s-evroremontom-v-tsentre-goroda-IDDr3Q7.html";
//var url_oll = "https://www.olx.ua/obyavlenie/garazh-IDIlCnZ.html#fbfc1c74fa;promoted";
//var url_oll ="https://www.olx.ua/obyavlenie/sdam-v-arendu-garazh-kooperativ-svtanok-IDJyLno.html#a77fbca3dd";
var url_oll ="https://www.olx.ua/obyavlenie/garazh-v-kooperative-teterev-IDJ7O5a.html#a77fbca3dd";

// сокращения url
var withoutLastChunk = url_oll.slice(0, url_oll.lastIndexOf("html"));
let may_url =  withoutLastChunk + "html"

getAds(may_url).then((xxx) => {    
console.log("объявление спарсили и вот что получилось:\n", xxx);
        //тут надо вызвать сохранение в БД
		const page2db = require('./pagetodb2');
        page2db.save(xxx);
    })
